...
namespace Opencart\Admin\Controller\Extension\Ngenius\Report;
...
class Ngenius extends Controller
{
    ...
    protected function getList()
    {
        ...
        $order_total = $this->model_extension_ngenius_report_ngenius->getTotalOrders($filter_data);
        $results     = $this->model_extension_ngenius_report_ngenius->getOrders($filter_data);
        ...
        $data['order_statuses'] = $this->model_extension_ngenius_report_ngenius->getNgeniusOrderSatuts();
